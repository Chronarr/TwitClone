            ...
            <div className='flex-1'>
                ...
                <div className='h-14 ml-2 flex  mt-2 min-w-full bottom-0 justify-between  border-t border-gray-200'>
                    ...
                    <div className='flex h-full item-center'>
                        ...
                        <button className='leading-none mr-2 rounded-md transition-all duration-300 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-size-200 bg-pos-0 hover:bg-pos-100 text-white w-20 h-10 my-auto pb-3 font-bold disabled:opacity-50' onClick={submitTweet} disabled={!input.trim()}>Tweet</button>
                    </div>
                </div>
            </div>
        </div>
